...
debugger
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-gray-100 rounded-lg shadow-md mt-10 bg-pink">
      ...
      <div className="mb-4">
        <CategoryDropdown selectedCategory={category} setSelectedCategory={setCategory} setSelectedCategoryId={setCategoryId} />
      </div>
      ...
      {/* Prep Time */}
      <div className="mb-4">
        <label className="block mb-1 font-medium text-gray-700">Prep Time (minutes):</label>
        <input
          type="number"
          min="0"
          className="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <div className="mb-6">
        ...
        <div
          ...
          className="relative cursor-pointer border-2 border-dashed border-gray-300 rounded-lg h-48 flex items-center justify-center overflow-hidden hover:border-blue-500 transition"
        >
          {imagePreview ? (
            <>
              <img
      ...
      <div className="mb-6 flex items-center">
        ...
        />
        <label htmlFor="isPublic" className="ml-2 block text-gray-700 font-medium">
          Public
        </label>
      </div>
      <div className="mb-6">
      ...
      {message && (
        <p
          className={`mt-4 text-center font-medium ${message.toLowerCase().includes("success") ? "text-green-600" : "text-red-600"
            }`}
        >
          {message}
        </p>
