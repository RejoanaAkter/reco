...
const CategoryList: React.FC = () => {
  ...
  const {
    ...
    error: recipeError,
    fadeIn,
  } = useRecipesByCategory(selectedCategoryId);
    ...
    <>
      <div className="flex flex-col md:flex-row  mx-auto py-10 px-6 gap-10 min-h-[500px] bg-gray-100 text-gray-700">
        ...
        <aside className="md:w-1/4">
          <div className="mb-6">
            <h4 className="text-sm tracking-wider text-gray-600 uppercase mb-1">
              Select Your Meal
            </h4>
        ...
        <main className="md:w-3/4 flex flex-col">
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              onClick={() => setShowCategoryCreate(true)}// Replace with your modal or form logic
